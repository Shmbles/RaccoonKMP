...
/**
 * Suite de pruebas unitarias para el motor de reglas de juego en modo local (Pass & Play),
 * verificando distribución de cartas, cálculo de mapaches, ataques de oso y fin de partida.
 */
